...
* The original package name 'com.rest.auth.mongo.spring-oauth2-rest-mongo' is invalid and this project uses 'com.rest.auth.mongo.springoauth2restmongo' instead.
